...
//            if (!empty($this->request->data['Block']['img']['name'])) {
//                $photographName = $this->ImageUpload->uploadImage( $this->request->data['Block']['img'], UPLOAD, true );
//                $this->request->data['Block']['img_path'] = $photographName['thumbnail'];
//            } else {
//                unset($this->request->data['Block']['img']);
//            }
