...
class ContactsController extends AppController {
     ...
     * @access public
     */
    public $uses = array('Contact','Album','Link');
    ...
    public function view($alias = null) {
        ...
        if (!empty($this->request->data) && $continue === true) {
            ...
            //$this->Contact->Message->save($this->request->data);
            if ($continue === true) {
                $this->Contact->Message->save($this->request->data);
                ...
                //echo $this->set('message' , ' Your message has been received');
            }
        }

        $this->set('title_for_layout', 'Contact');
        $this->set(compact('continue'));
        $albums = $this->Album->find('all', array('order' => 'Album.id DESC'));
