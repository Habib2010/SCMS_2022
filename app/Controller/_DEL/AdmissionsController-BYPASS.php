            ...
            if ($pStat && $aStat) {
                ...
                if (empty($admitter)) {
                    ...
                    if ($response && !empty($response->transaction)) {
                        if (1 || $response->transaction->trxStatus == '0000') { //XXXXXXXXXXXXXXXXXXXXXXXXXXx
                            if (1 || $response->transaction->reference == $REF) { //XXXXXXXXXXXXXXXXXXXXXXXXXXx
                                if (1 || $response->transaction->amount == $this->pAmount) { //XXXXXXXXXXXXXXXXXXXXXXXXXXx
                                    ...
                                    $pStatus = $this->Payment->save(
                                            array('Payment' => array(
                                            'trxId' => $trxId,
                                            'amount' => $this->pAmount, //$response->transaction->amount
                                            'sender' => '--', //$response->transaction->sender,
                                            'receiver' => '---', //$response->transaction->receiver,
                                            'pay_date' => date('Y-m-d H:i:s'), //$response->transaction->trxTimestamp,
                                    ...
                                    if ($aStatus && $pStatus) {
                                        ...
                                        $dataSource->rollback();
                                        $validationErrors['pErr'] = 'Verification Error! Please contact with administrator';
                                    }
                                } else {
