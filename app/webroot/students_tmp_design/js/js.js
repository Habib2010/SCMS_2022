...
jQuery(document).ready(function($){
    ...
    $('input#alterAllrChk').change(function(){
        var chkrStatus = $(this).is(':checked');
        $(".tblroll .regular-ref-checkbox:checkbox").prop("checked",chkrStatus).parent('span').toggleClass('checked',chkrStatus);
    });
    ...
    $('a.close2').click(function(){		
        if(!$(this).hasClass('close')) {
            ...
            $('div.rightWraper').animate({
                width:'22%', 
                padding:'8px .5%'
            }, 700, function(){
                $('a.close2').addClass('close');
            });
            $('div.left_wrapper').animate({
                width:'74%'
            }, 700, function(){});
        } else {
            $('div.rightWraper').animate({
