            ...
            if (!empty(${strtolower($this->name)})) {
                foreach (${strtolower($this->name)} as $item) {
                    $actions = $this->Html->link(
                            __('Edit'), array('action' => 'edit', $item[$modelClass]['id'])
                    );
                    ...
                    /* if( !empty($item['User']['capabilities']) ){
                      $allCaps = @unserialize(trim($item['User']['capabilities']));
                      $item['User']['capabilities'] = $allCaps['level'].'-'.$allCaps['section'];
                      } */
