...
<div class="details">
    ...
    <div class="details_right">                	              	
        ...
        <address><?php if ($profile['Employee']['designation']): ?> পদবী : <?php echo $profile['Employee']['designation']; ?><br/><?php endif; ?>
...
<?php echo $this->Html->link(__('Edit', true), array('controller' => 'employees', 'action' => 'edit')); ?>
