<?php 
	$notice = $this->requestAction('nodes/syllabus'); 
	$count = $this->requestAction('nodes/syllabus'); 
?>
        <ul>
		<?php 
	...
	<?php if($count['count']>5){ ?>
		<div class="lwrLink">
			<a href="<?php echo $this->request->base ?>/syllabus" class="lwrLink">সবগুলো জানতে &raquo;</a>
		</div>
	<?php } ?>
