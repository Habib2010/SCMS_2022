<?php 
	$notice = $this->requestAction('nodes/exam_routine'); 
	$count = $this->requestAction('nodes/exam_routine'); 
?>
        <ul>
		<?php 
	...
	<?php if($count['count']>5){ ?>
		<div class="lwrLink">
			<a href="<?php echo $this->request->base ?>/exam_routine" class="lwrLink">সবগুলো জানতে &raquo;</a>
		</div>
	<?php } ?>
