                ...
                <div class="formTopWrapper">
                	<div class="displayWrapper"<?php if( empty($students) || !empty($this->request->data) ) echo ' style="display:block"'; ?>>
                    	<?php echo $this->Form->create('Admitcard',array('action'=>'index')); ?>
                            ...
                            <div class="set_wrapper">
                                <div class="infofoset itemfirstset">
                                	...
                                	<div class="infofoset" >
                                    	<?php echo $this->Form->input('start_date', array('type' => 'text ', 'id' => 'datepicker', 'label' => '** Start Date :')); ?>
                                    </div>
                                	<div class="infofoset itemlastset">
                                    	<?php echo $this->Form->input('end_date', array('type' => 'text ', 'id' => 'datepicker1', 'label' => '** End Date :')); ?>
                                    </div>
                                 </div>
                            <div class="set_wrapper">
