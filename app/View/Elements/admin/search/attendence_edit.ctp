<div class="formTopWrapper">
    <div class="displayWrapper"<?php if (empty($students) || !empty($this->request->data)) echo ' style="display:block"'; ?>>
        <?php echo $this->Form->create('Attendences', array('action' => 'view_attendence')); ?>
        ...
        <div class="set_wrapper">
            <div class="infofoset itemfirstset">
                <?php echo $this->Form->input('date', array('type' => 'text ', 'id' => 'datepicker', 'label' => 'Select Date :', 'style' => 'height: 25px; margin-top:10px;')); ?>
            </div><!-- end of infofoset-->
            <div class="infofoset">
                &nbsp;
            </div><!-- end of infofoset-->
