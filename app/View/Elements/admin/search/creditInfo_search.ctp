<div class="formTopWrapper">
    <div class="displayWrapper"<?php  echo ' style="display:block"'; ?>>
        <?php echo $this->Form->create('Credit', array('action' => 'credit_report', 'admin' => true, 'type' => 'get')); ?>
        <div class="set_wrapper">
            <div class="infofoset itemfirstset">
                <?php echo $this->Form->input('start_date', array('type' => 'text ', 'id' => 'datepicker', 'label' => '** Credit Date From :')); ?>
            </div><!-- end of infofoset-->
            <div class="infofoset">
                <?php
                echo $this->Form->input('bank_id', array('label' => 'Credit From: ', 'empty' => 'All', 'options' => $bankId));
                ?>
            </div><!-- end of infofoset-->
        ...
        <div class="set_wrapper">
            <div class="infofoset itemfirstset">
                <?php echo $this->Form->input('end_date', array('type' => 'text ', 'id' => 'datepicker1', 'label' => '** Credit Date To:')); ?>
            </div><!-- end of infofoset-->
            <div class="infofoset">
