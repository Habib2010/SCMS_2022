<div class="formTopWrapper">
    <div class="displayWrapper"<?php if (!empty($debits) || !empty($this->request->data) || !empty($this->params->query)) echo ' style="display:block"'; ?>>
        <?php echo $this->Form->create('Debit', array('action' => 'index', 'type' => 'get')); ?>
        ...
        <div class="set_wrapper">
            <div class="infofoset itemfirstset">
                <?php
                echo $this->Form->input('debit_date', array('label' => 'Date', 'type' => 'text', 'class' => 'input_Txt', 'style' => 'width:52%', 'id'=>'datepicker'));
                ?>
            </div><!-- end of infofoset-->
            <div class="infofoset">
                 &nbsp;
