<?php 
	$notice = $this->requestAction('nodes/result'); 
	$count = $this->requestAction('nodes/result'); 
?>
        <ul>
		<?php 
	...
	<?php if($count['count']>5){ ?>
		<div class="lwrLink">
			<a href="<?php echo $this->request->base ?>/result" class="lwrLink">সবগুলো জানতে &raquo;</a>
		</div>
	<?php } ?>
