	...
	<fieldset>
		<div class="tabs">
			<ul>
				...
				<?php echo $this->Layout->adminTabs(null,$type); ?>
			</ul>
			...
			<?php
				...
				echo $this->Form->input('title', [ 'label'=>'English Title']);
				echo $this->Form->input('bn_title', ['label'=>'Bangla Title']);
				echo $this->Form->input('slug');
				echo $this->Form->input('excerpt');
				echo $this->Form->input('bn_excerpt', ['label'=>'Bangla Excerpt']);
				echo $this->Form->input('body', array('label'=>'English Body'));
				echo $this->Form->input('bn_body', array('label'=>'Bangla Body'));
			?>
			</div>
